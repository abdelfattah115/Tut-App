...
import 'package:udvanced_flutter/app/extensions.dart';
  ...
  HomeObject toDomain() {
    List<Service> services = (this
        ...
        ?.map((servicesResponse) =>
            servicesResponse.toDomain()) ?? const Iterable.empty())
        .cast<Service>()
        .toList();
    ...
    List<BannerAd> banners = (this
        ...
        ?.banners
        ?.map((bannersResponse) =>
        bannersResponse.toDomain()) ?? const Iterable.empty())
        .cast<BannerAd>()
        .toList();
    ...
    List<Store> stores = (this
        ...
        ?.stores
        ?.map((storesResponse) =>
        storesResponse.toDomain()) ?? const Iterable.empty())
        .cast<Store>()
        .toList();
